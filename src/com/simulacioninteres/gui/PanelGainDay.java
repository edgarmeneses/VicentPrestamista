...
public class PanelGainDay extends JPanel{
	...
	public PanelGainDay(FactorLoan factorLoan) {
		// TODO Auto-generated constructor stub
		this.factorLoan = factorLoan;
		setLayout(new BorderLayout());
		JPanel panel = new JPanel();
		panel.setLayout(new GridLayout(2, 2));
		lblday = new JLabel("Ingrese el dia");
	...
	private void calculate(){
		...
		calculate.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				// TODO Auto-generated method stub
				int ganOfDay = (int) factorLoan.gaiOfDay(Integer.valueOf(txtDay.getText()));
				txtResult.setText("$"+ ganOfDay);
			}
		});
